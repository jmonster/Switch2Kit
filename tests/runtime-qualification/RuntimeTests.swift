...
@main enum RuntimeTests {
    static func main() throws {
        let info: [String: Any] = ["CFBundleIdentifier": "wabisabi.ware.gamecubed",
            "LSMinimumSystemVersion": "15.0", "Switch2KitSourceRevision": String(repeating: "a", count: 40),
            "Switch2KitSourceDirty": false, "Switch2KitBuildArchitecture": RuntimeCompatibility.architecture]
