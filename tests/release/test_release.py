...
class ReleaseTests(unittest.TestCase):
    def setUp(self):
        ...
        self.info = {'CFBundleIdentifier': release.BUNDLE_ID, 'CFBundleExecutable': 'App',
                     'S2KSourceRevision': 'a' * 40, 'S2KSourceDirty': False, 'LSMinimumSystemVersion': '15.0'}
        self.save_info()
    ...
    def test_dirty_wrong_bundle_revision_and_unsafe_entitlements_rejected(self):
        for key, value in [('S2KSourceDirty', True), ('CFBundleIdentifier', 'upstream.id'), ('S2KSourceRevision', 'b'*40)]:
