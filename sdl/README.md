...
The build uses pinned SDL commit
...
Run the build command from the Switch2Kit checkout. Its output is
`build/sdl/libSDL3.0.dylib` and its SHA-256 checksum. Alternatively, a successful **SDL input
