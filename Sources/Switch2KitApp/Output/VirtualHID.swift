            ...
            while true {
                ...
                case let .activate(token, model):
                    ...
                    let props = HIDVirtualDevice.Properties(
                        ...
                        transport: nil, product: "\(model.displayName) (Switch2Kit)",
                        manufacturer: "Switch2Kit",
                        serialNumber: "S2K-slot\(index + 1)", uniqueID: "com.petersharma.switch2kit.slot\(index + 1)")
