...
struct SupportSummaryView: View {
    ...
    @MainActor private func prepare() {
        ...
        do {
            preview = try SupportSummary.make(revision: bundle["Switch2KitSourceRevision"] as? String,
                dirty: bundle["Switch2KitSourceDirty"] as? Bool, os: ProcessInfo.processInfo.operatingSystemVersion,
    ...
    @MainActor private func save() {
        ...
        panel.nameFieldStringValue = "switch2kit-support.json"
        saving = true
