...
struct SupportSummaryView: View {
    ...
    @MainActor private func prepare() {
        ...
        do {
            preview = try SupportSummary.make(revision: bundle["S2KSourceRevision"] as? String,
                dirty: bundle["S2KSourceDirty"] as? Bool, os: ProcessInfo.processInfo.operatingSystemVersion,
