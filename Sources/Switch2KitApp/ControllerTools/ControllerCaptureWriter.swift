...
final class ControllerCaptureWriter: @unchecked Sendable {
    ...
    private let writerQueue = DispatchQueue(label: "Switch2KitApp.capture", qos: .utility)
    ...
    private let completion: @Sendable (ControllerToolCapture) -> Void
    private var packetCount = 0
    private var closed = false

    init(directory: URL, completion: @escaping @Sendable (ControllerToolCapture) -> Void) throws {
