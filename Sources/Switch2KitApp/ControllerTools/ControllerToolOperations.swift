...
final class ControllerToolOperations: @unchecked Sendable {
    ...
    let events: ControllerToolEventPipe
    ...
    init(session: ControllerToolSession, events: ControllerToolEventPipe) {
    ...
    private func nfcFinish(session: ControllerToolSession, assembled: Data, uid: Data) {
        ...
        events.submit(.nfcTagRead(id, ControllerToolTag(uid: uidString,
