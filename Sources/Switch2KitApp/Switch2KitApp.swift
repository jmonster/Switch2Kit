// Switch2KitApp.swift
// Menu-bar application and dashboard scenes.
//
...
struct Switch2KitApp: App {
    ...
    var body: some Scene {
        ...
        Window("Switch2Kit", id: "dashboard") {
            VStack(spacing: 0) {
    ...
    var body: some View {
        Image(systemName: engine.controllers.isEmpty
            ...
            .accessibilityLabel(engine.controllers.isEmpty
                ? "Switch2Kit — no controllers connected"
                : "Switch2Kit — \(engine.controllers.count) connected")
    }
}
...
final class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        bridgeLog(.info, "app", "Switch2Kit — starting bridge")
...
struct MenuContent: View {
    ...
    var body: some View {
        ...
        Button("Build and Installation Help…") {
            NSWorkspace.shared.open(URL(string: "https://github.com/jmonster/Switch2Kit#dashboard")!)
        }
